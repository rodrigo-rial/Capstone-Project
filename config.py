...
PALABRAS_URGENCIA_ALTA = {
    # emergencias parte 2
    "rcp", "reanimación", "cardiopulmonar", "desfibrilador", 
    "paro cardíaco", "parocardiaco",
    ...
    "desmayo", "desmayar", "desmayando", "perdio el conocimiento", "inconsciente", "síncope",
...
URL_API_DEA = "https://rakl3h53bqvghzkqusblfojnay0lntwd.lambda-url.sa-east-1.on.aws/"

# contactos de emergencia
CONTACTO_EMERGENCIA_AR = "Llame inmediatamente a la ambulancia (107), policía (911) o bomberos (100). Si necesita localizar un desfibrilador, utilice el comando /dea."